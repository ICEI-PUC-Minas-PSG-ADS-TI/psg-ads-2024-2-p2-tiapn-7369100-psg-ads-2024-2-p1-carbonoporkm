...
[PROCESSO 7 - Doação para Compensação de Emissões com Login](./processos/processo-7-Doação-para-Compensação-de-Emissões-com-Login.md "Usuários logados podem realizar ações diretamente pela plataforma, que registram a doação em nome do usuário e fornecem relatórios de impacto.")<br>
